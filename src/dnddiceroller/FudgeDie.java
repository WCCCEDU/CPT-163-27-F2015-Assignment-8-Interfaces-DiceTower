...
public class FudgeDie implements Die {
    ...
    */
    ...
    public void roll(){
        ...
        // 0 and 1 are valid values for a fudge die
        // 2 is not a valid value so change it to the 3rd valid value of -1
        if (this.dieNum == 2){this.dieNum = -1;}
    }
     ...
     * @param s     user entered number of sides on this die
     * @return      error message if number of sides is invalid
     */
    public void checkSides(){
        if (this.dieSides % 3 != 0) {
            this.errorMsg = "Number of sides for Fudge die not legal.";
        }
    }
